<<<<<<< HEAD
  ...
  const nextConfig = {
    ...
    async redirects() {
      return [
        { source: "/2021/07/19/you-are-called-to-be-an-apprentice-of-jesus-what-does-that-really-look-like", destination: "/articles/you-are-called-to-be-an-apprentice-of-jesus-what-does-that-really-look-like", permanent: true },
        { source: "/about", destination: "/about-us", permanent: true },
        { source: "/author/jonichiang", destination: "/", permanent: true },
        { source: "/2021/08/03/what-if-we-aim-to-bless-people-instead-of-convert-them", destination: "/articles/what-if-we-aim-to-bless-people-instead-of-convert-them", permanent: true },
        { source: "/2021/06/15/what-does-it-mean-to-be-righteous-and-why-does-it-matter", destination: "/articles/what-does-it-mean-to-be-righteous-and-why-does-it-matter", permanent: true },
        { source: "/2021/11/19/healing-the-trauma-of-homelessness-through-affordable-housing", destination: "/articles/healing-the-trauma-of-homelessness-through-affordable-housing", permanent: true },
        { source: "/global-leadership-circle-information-session-recording", destination: "/leadership-circle", permanent: true },
        { source: "/home", destination: "/", permanent: true },
        { source: "/donate", destination: "/donation", permanent: true },
        { source: "/team", destination: "/", permanent: true },
        { source: "/2021/07/06/how-genesis-1-helps-us-understand-the-great-commission-better", destination: "/articles/how-genesis-1-helps-us-understand-the-great-commission-better", permanent: true },
        { source: "/2021/06/09/god-created-the-world-to-be-one-beautiful-orchestra-do-you-know-your-part", destination: "/articles/god-created-the-world-to-be-one-beautiful-orchestra-do-you-know-your-part", permanent: true },
        { source: "/denver-leadership-circle", destination: "/leadership-circle", permanent: true },
        { source: "/blog/page/3", destination: "/articles", permanent: true },
        { source: "/tag/personal-development", destination: "/", permanent: true },
        { source: "/vantagepoint-tier2", destination: "/vantage-point", permanent: true },
        ...
        { source: "/2021/08/09/god-never-wanted-you-to-divide-your-life-into-sacred-and-secular", destination: "/articles/god-never-wanted-you-to-divide-your-life-into-sacred-and-secular", permanent: true },
...
>>>>>>> 5973192125debeead80a519be59da29deffe85c9
